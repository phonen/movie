...
<p style="padding: 0 4px;">'; echo $aik['foot'];?><br/>管理员邮箱：<?php echo $aik['admin_email'];?><br/>&copy; 2018 <a href="<?php echo $aik['pcdomain'];?>"><?php echo $aik['sitename'];?><?='</a>&nbsp; <a href="http://www.miitbeian.gov.cn">'; echo $aik['icp'];?> &nbsp; <?php echo $aik['tongji'];?><?=' </footer>
